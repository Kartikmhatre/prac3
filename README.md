...
CREATE TABLE IF NOT EXISTS Fact_Sales (SalesID INTEGER PRIMARY KEY, ProductID INTEGER, CustomerID INTEGER, Quantity INTEGER, Amount REAL, FOREIGN KEY (ProductID) REFERENCES Dim_Product(ProductID), FOREIGN KEY (CustomerID) REFERENCES Dim_Customer(CustomerID));
""")
